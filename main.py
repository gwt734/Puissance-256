...
def main():
    ...
    while veut_rejouer:
        is_base_param = functions.input_protege("Souhaitez-vous jouer avec les paramètres de base ?", range_or_list="list", valid_answers_list=["oui", "Oui", "OUI", "non", "Non", "NON"],window=window,fonts=fonts, default_answer="oui") in [
            "oui", "Oui", "OUI"]
        if is_base_param:
